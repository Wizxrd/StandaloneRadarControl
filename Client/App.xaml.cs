...
namespace Client
{
    public partial class App : Application
    {
        ...
        {
            base.OnStartup(e);
            SplashScreenView splashWindowView = new SplashScreenView();
            ...
            Task.Delay(3000).ContinueWith(_ =>
            {
                splashWindowView.Dispatcher.Invoke(() =>
                {
                    ...
                    mainWindow.Show();
                    LoadProfileView loadProfileWindow = new LoadProfileView(mainWindow.navigate)
                    {
                    ...
                    {
                        loadProfileWindow.Dispatcher.Invoke(() =>
                        {
