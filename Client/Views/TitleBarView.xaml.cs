...
{
	private readonly int doubleClickSpeed = 250;
	...
	private void MenuButtonClick(object sender, RoutedEventArgs e)
	{
		...
		if (window is MainWindowView mainWindow) mainWindow.MenuPopup.IsOpen = !mainWindow.MenuPopup.IsOpen;
	}
	...
	private void TitleBarMouseDown(object sender, MouseButtonEventArgs e)
	{
		...
		if (window is MainWindowView mainWindow)
		{
			...
			if (timeSpan.TotalMilliseconds <= doubleClickSpeed) MaximizeButtonClick(sender, e);
	...
	{
		var window = Window.GetWindow(this);
		if (window is MainWindowView mainWindow) mainWindow.WindowState = WindowState.Minimized;
	}
