...
public class SignalRClient
{
    ...
    public static async Task<bool> AsyncDisconnect()
    {
        ...
        App.ServerBookmark = null;
    }

    public static Task AsyncSendCommand(string command, object payload)
    {
        if (Connection == null || Connection.State != HubConnectionState.Connected)
            ViewManager.MessagesViewModel.AddMessage($"Not connected to server", MessageChannel.All, Brushes.Red);
        ...
        return Connection.InvokeAsync("ReceiveEnvelope", json);
    }
}
